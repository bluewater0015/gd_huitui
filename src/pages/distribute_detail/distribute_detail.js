...
export default class Distribute extends Component{
	...
	confirmEvent() {
		...
		console.log('派发时上传之前的图片：',this.state.form.files);
	...
	getfiles(acceptedFiles, rejectedFiles) {
		console.log('在父组件中得到压缩之后的图片：',acceptedFiles);
		this.setState({
	      ...this.state, form: {
	        ...this.state.form,
	        files: acceptedFiles
	...
	getSrcEvent(src) {
		//console.log("src",src);
		//console.log("111",acceptedFiles[1].preview);
		this.setState({
			blackShade: true,
			src: src
		})
			...
			<div className="distribute">
				...
				<div className="distribute_message">
					...
					<div className="margin-bottom">
						...
						getSrc={ this.getSrcEvent.bind(this)} 
